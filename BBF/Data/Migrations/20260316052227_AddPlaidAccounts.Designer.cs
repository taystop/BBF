...
namespace BBF.Migrations
{
    ...
    [Migration("20260316052227_AddPlaidAccounts")]
    partial class AddPlaidAccounts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BBF.Data.Entities.BudgetCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BBF.Data.Entities.ChatConversationShare", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("SharedWithGroupId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ChatConversationShares");
                });
            ...
            modelBuilder.Entity("BBF.Data.Entities.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BBF.Data.Entities.UserGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BBF.Data.Entities.ChatConversation", b =>
                {
                    b.HasOne("BBF.Data.ApplicationUser", "User")
            ...
            modelBuilder.Entity("BBF.Data.Entities.ChatConversationShare", b =>
                {
                    ...
                    b.HasOne("BBF.Data.Entities.UserGroup", "SharedWithGroup")
                        .WithMany()
                        .HasForeignKey("SharedWithGroupId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("BBF.Data.ApplicationUser", "SharedWithUser")
                        .WithMany()
