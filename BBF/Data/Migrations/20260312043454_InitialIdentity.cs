...
namespace BBF.Migrations
{
    ...
    public partial class InitialIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ServiceHealthLogs",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ServiceLinkId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceHealthLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceHealthLogs_ServiceLinks_ServiceLinkId",
                        column: x => x.ServiceLinkId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceHealthLogs_ServiceLinkId",
                table: "ServiceHealthLogs",
                column: "ServiceLinkId");
        }
